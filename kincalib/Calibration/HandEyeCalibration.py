"""
    Hand-Eye Calibration solver taken from: https://github.com/eayvali/Pose-Estimation-for-Sensor-Calibration/blob/master/Pose_Estimation_Class.py
...
class HandEyeBatchProcessing:
    def pose_estimation(A, B):
        ...
        Y_est_check, ErrorStats = HandEyeBatchProcessing.__rigid_registration(
            A, X_est, B
        )
